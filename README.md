...
YS CAMERA EDITOR is a browser-based replay file editor for YSFlight, inspired by the original YS CAMERA.
...
YS CAMERA EDITOR is intended as a tool for creating individual shots rather than automatically producing a complete video. Adjust the camera settings for each shot, capture the footage you need, and assemble the resulting clips in a video editor.
